...
Pacote  : br.com.extrator.integracao.constantes
...
package br.com.extrator.integracao.constantes;
...
public final class ConstantesApiDataExport {
    ...
    private static final Map<String, ConfiguracaoEntidade> CONFIGURACOES = Map.of(
        ...
        new ConfiguracaoEntidade(
            ...
            "manifests",                    // tabelaApi
            "100",                          // valorPer (alinhado com request oficial para reduzir timeout 422)
