...
Pacote  : br.com.extrator.suporte.validacao
...
public final class ConstantesEntidades {
    ...
    /** 
     * Obtem o delay padrao entre extracoes de entidades.
     * Utiliza a configuracao de extracao.delay.ms da camada de configuracao de ETL.
