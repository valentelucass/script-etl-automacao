...
Pacote  : br.com.extrator.persistencia.entidade
...
public class FaturaPorClienteEntity {
    ...
    public void setLegacyUniqueIds(final List<String> legacyUniqueIds) {
        this.legacyUniqueIds = legacyUniqueIds == null ? List.of() : List.copyOf(legacyUniqueIds);
    }
