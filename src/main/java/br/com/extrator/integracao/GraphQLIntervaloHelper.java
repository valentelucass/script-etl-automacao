/* ==[DOC-FILE]===============================================================
Arquivo : src/main/java/br/com/extrator/api/GraphQLIntervaloHelper.java
...
public final class GraphQLIntervaloHelper {
    ...
    private static <T> ResultadoExtracao<T> executarDiaComRetry(
        ...
        final int maxTentativas = Math.max(1, ConfigApi.obterMaxTentativasRetryGraphQLPorDia());
        final long delayBaseMs = Math.max(500L, ConfigApi.obterDelayBaseRetry());
