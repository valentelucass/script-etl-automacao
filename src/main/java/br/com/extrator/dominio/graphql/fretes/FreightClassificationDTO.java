/* ==[DOC-FILE]===============================================================
Arquivo : src/main/java/br/com/extrator/modelo/graphql/fretes/FreightClassificationDTO.java
Classe  : FreightClassificationDTO (class)
Pacote  : br.com.extrator.dominio.graphql.fretes
Modulo  : DTO/Mapper GraphQL
Papel   : Implementa responsabilidade de freight classification dto.
