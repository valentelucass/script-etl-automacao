 ...
 * - pick_sequence_code (quando apenas pick_sequence_code está disponível)
 * - sequence_code + mdfe_number (quando apenas mdfe_number está disponível)
 * - hash SHA-256 do metadata (quando pick_sequence_code e mdfe_number são NULL)
 */
